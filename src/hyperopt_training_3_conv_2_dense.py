...
class HyperOptimizer():
    ...
    def run_with(self,conv_layer_lambda_one, conv_filter_num_one, conv_filter_size_one, 
        ...
        "conv_layers":[(conv_filter_num_one, conv_filter_size_one, conv_layer_lambda_one),
                       (conv_filter_num_two, conv_filter_size_two, conv_layer_lambda_two),
                       (conv_filter_num_three, conv_filter_size_three, conv_layer_lambda_three)],
        "lstm_layers": [],
