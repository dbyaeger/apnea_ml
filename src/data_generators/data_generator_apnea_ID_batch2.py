...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 22:11:58 2020
...
class DataGeneratorApneaIDBatch2(Sequence):
    ...
    def __init__(self, data_path: str = '/Users/danielyaeger/Documents/raw_apnea_data',
                 ...
                 use_staging: bool = True, normalizer: callable = None,
...
class DataGeneratorApneaAllWindows(DataGeneratorApneaIDBatch2):
...
if __name__ == "__main__":
    dg = DataGeneratorApneaIDBatch2(data_path = '/Users/danielyaeger/Documents/raw_apnea_data',
                                  mode = 'train',
                                  batch_size=128,
                                  shuffle = True,
                                  sampling_rate=10,
