...
class HyperOptimizer():
    ...
    def __init__(self, data_path: str, model_path: str, results_path: str,
                 experiment_name: str = 'seven_conv_two_dense',
                 ...
                 variables: list = ['conv_layer_lambda_one', 'conv_filter_num_one',
                                    ...
                                    'conv_layer_lambda_six', 'conv_filter_num_six', 
                                    'conv_filter_size_six',
                                    'conv_layer_lambda_seven', 'conv_filter_num_seven', 
                                    'conv_filter_size_seven',
                 ...
                 arguments: list = [(1e-16,1),(32,256,32), (1,100,1),
                                    ...
                                    (1e-16,1), (32,256,32), (1,70,1),
                                    (1e-16,1), (32,256,32), (1,70,1),
                                    (1e-16,1), (32,256,32), (1,30,1),
                                    (1e-16,1), (32,256,32), (1,10,1),
                                    (1e-16,1), (32,256,32), (1,6,1),
                                    (32,1024,32), (1e-12,1)]):
    ...
    def objective(self, params):
        ...
        for parameter_name in ['conv_filter_num_one','conv_filter_size_one',  
                               ...
                               'conv_filter_num_six', 'conv_filter_size_six',
                               'conv_filter_num_seven', 'conv_filter_size_seven',
                               'fc_neurons']:
    ...
    def run_with(self,conv_layer_lambda_one, conv_filter_num_one, conv_filter_size_one, 
                 ...
                 conv_layer_lambda_six, conv_filter_num_six, conv_filter_size_six,
                 conv_layer_lambda_seven, conv_filter_num_seven, conv_filter_size_seven,
                 fc_neurons, fc_layer_lambda):
        ...
        "conv_layers":[(conv_filter_num_one, conv_filter_size_one, conv_layer_lambda_one, True),
                       ...
                       (conv_filter_num_six, conv_filter_size_six, conv_layer_lambda_six, False),
                       (conv_filter_num_seven, conv_filter_size_seven, conv_layer_lambda_seven, False)],
        "lstm_layers": [],
